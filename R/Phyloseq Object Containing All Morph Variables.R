...
# Formatting the gill metadata with all method_gear
...
# Formatting the hindgut metadata with all method_gear
...
# Formatting the midgut metadata with all method_gear
...
# Formatting the skin metadata with all method_gear
...
write.csv(gill_metadata_phylo, file = "gillmetadata.csv", row.names = FALSE)
